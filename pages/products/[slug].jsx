            ...
            <div className={`${styles.product_info_panel} flex flex-wrap align-center justify-center items-center min-h-full`}>
              <div className={`${styles.product_info_panel_inner} w-full lg:px-10 md:px-7 px-5`}>
                <Tween from={{ y: 30, delay: 0.8, opacity: 0 }} duration={0.7} stagger={0.2} ease="power3.out">
                  ...
                  <h1 className={`product_title xl:py-8 py-5`}>{productDetails.name}</h1>
                  <div className={`product_price lg:text-3xl text-2xl`}>${productDetails.price}</div>
                  <div>
                    <AddToCartForm product={productDetails} />
                  </div>
                  <div className="product_description">{ReactHtmlParser(productDetails.description)}</div>
                </Tween>
              </div>
            </div>
          </div>
