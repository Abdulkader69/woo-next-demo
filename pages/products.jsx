...
export const getStaticProps = async () => {
  ...
  const productsByCategory = await getProductsByCategory(16);
  return {
    props: { products, totalPages, productsByCategory },
  };
};

const Products = ({ products, totalPages, productsByCategory }) => {
  ...
  return (
    <>
      <Head>
        <title>Products : Next WooCommerce</title>
      </Head>
